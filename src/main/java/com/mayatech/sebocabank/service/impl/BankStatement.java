...
public class BankStatement {
    ...
    private static final String FILE = "C:\\Users\\DELL\\Documents\\MyStatement.pdf";
    /**
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate, String endDate) throws FileNotFoundException, DocumentException {
        ...
        PdfPCell bankName = new PdfPCell(new Phrase("Seboca Bank"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(10f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("Ilot D Tevragh-Zeina, villa N° 39 , Nouakchott Mauritania"));
